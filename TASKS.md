...
| T-009 | QA suite full-run stabilization (3 intermittent failures) | BLOCKED | scripts/qa/run2.spec.ts | make qa-run2 must exit 0, all 14 tests green | Team | codex/profiles-v2-adoption | See SESSION_STATE.md for root cause and fix approach per test |
