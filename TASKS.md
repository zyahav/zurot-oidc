...
| T-007 | Update translation engine — add game product, explicit client mapping, scope isolation | IN_PROGRESS | docs/implementation/t-007-translation-engine-game-spec.md | lint + build + scope isolation tests | Team | codex/game-translation | Phase 1 of game auth — must complete before T-008 |
| T-008 | Add ZurOt auth integration to mall-hebrew-adventures | PLANNED | docs/implementation/t-008-mall-auth-spec.md | lint + build + auth flow smoke | Team | codex/mall-auth | Phase 2 — depends on T-007 |
