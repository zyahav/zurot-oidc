...
| T-010 | Root route 404, sign-out modal persists, manage gate uses env var not Clerk | PLANNED | docs/implementation/t-010-spec.md | / redirects correctly, sign-out modal clears, manage gate accepts Clerk password, lint 0 errors, qa-run2 14/14 | Team | codex/root-signout-gate | See t-010-spec.md |
