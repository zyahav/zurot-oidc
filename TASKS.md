...
| T-004 | Implement profile edit (mutation + UI) | IN_PROGRESS | docs/implementation/t-004-profile-edit-spec.md | CRUD smoke + lint/build | Team | `codex/profile-edit` | Create/archive already exists |
