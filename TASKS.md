...
| T-007 | Update translation engine — add game product, explicit client mapping, scope isolation | PLANNED | docs/implementation/t-007-translation-engine-game-spec.md | lint + build + scope isolation tests | Team | codex/game-translation | Phase 1 of game auth — must complete before T-008 |
