...
| T-003 | Replace harness homepage with real product homepage | IN_PROGRESS | BASELINE.md, docs/implementation/t-003-homepage-spec.md | `npm run lint`, `npm run build`, homepage smoke | Team | `codex/homepage` | Keep OIDC test page available internally |
