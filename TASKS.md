...
| T-002 | Add minimal smoke tests for OIDC contract | READY_FOR_REVIEW | BASELINE.md | Discovery, JWKS, token invalid request, userinfo unauthorized | Team | `codex/smoke-tests` | Smoke runner added via `npm run smoke:oidc` and `make smoke-oidc` |
