...
| T-006 | Integrate first federated app end-to-end | IN_PROGRESS | docs/implementation/t-006-first-federated-app-spec.md | full auth/logout smoke + lint/build | Team | `codex/first-federated-app` | Validate real consumer behavior |
