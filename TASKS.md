...
| T-011 | Account PIN gate for Manage Profiles (parental boundary, Netflix model) | PLANNED | docs/implementation/t-011-spec.md | PIN setup, unlock, cooldown, recovery via email OTP, 14/14 QA | Team | codex/account-pin-gate | See t-011-spec.md. Replaces T-010 placeholder gate. |
