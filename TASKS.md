...
| T-005 | Implement logout/session strategy for federation | IN_PROGRESS | docs/implementation/t-005-logout-spec.md, docs/implementation/t-005-logout-decisions.md | logout flow smoke + lint/build | Team | `codex/logout-strategy` | Must complete before first federated app |
